...
Rebuilt mirror of [Openwrt-Passwall/openwrt-passwall2](https://github.com/Openwrt-Passwall/openwrt-passwall2) **26.5.1-1**,
...
Per-arch zip archives on the [`26.5.1-1`](https://github.com/huruojin/build-passwall2-repo/releases/tag/26.5.1-1) release:

- [passwall2-x86_64-26.5.1-1.zip](https://github.com/huruojin/build-passwall2-repo/releases/download/26.5.1-1/passwall2-x86_64-26.5.1-1.zip)
- [passwall2-aarch64_cortex-a53-26.5.1-1.zip](https://github.com/huruojin/build-passwall2-repo/releases/download/26.5.1-1/passwall2-aarch64_cortex-a53-26.5.1-1.zip)
- [passwall2-aarch64_generic-26.5.1-1.zip](https://github.com/huruojin/build-passwall2-repo/releases/download/26.5.1-1/passwall2-aarch64_generic-26.5.1-1.zip)
