...
Rebuilt mirror of [Openwrt-Passwall/openwrt-passwall2](https://github.com/Openwrt-Passwall/openwrt-passwall2) **26.9.12-2**,
...
Per-arch zip archives on the [`26.9.12-2`](https://github.com/huruojin/build-passwall2-repo/releases/tag/26.9.12-2) release:

- [passwall2-x86_64-26.9.12-2.zip](https://github.com/huruojin/build-passwall2-repo/releases/download/26.9.12-2/passwall2-x86_64-26.9.12-2.zip)
- [passwall2-aarch64_cortex-a53-26.9.12-2.zip](https://github.com/huruojin/build-passwall2-repo/releases/download/26.9.12-2/passwall2-aarch64_cortex-a53-26.9.12-2.zip)
- [passwall2-aarch64_generic-26.9.12-2.zip](https://github.com/huruojin/build-passwall2-repo/releases/download/26.9.12-2/passwall2-aarch64_generic-26.9.12-2.zip)
